        ...
        yAxes: [{
          ticks: {
            callback: function callback(a) {
              if ((a == 4)) return "Happy" ;
              else if ((a == 3)) return "Neutral" ;
              else if ((a == 2)) return "Sad" ;
              else if ((a == 1)) return "Angry" ;
              else if ((a == 0)) return "No Entry" ;
            }
          }
        }]
      },
        ...
        callbacks: {
          label: function label(a, e) {
            var t = e.datasets[a.datasetIndex].label || "",
                r = "";
            var o="";
                if ((a.yLabel == 4)) o="Happy" ;
                else if ((a.yLabel == 3)) o= "Neutral" ;
              else if ((a.yLabel == 2)) o= "Sad" ;
              else if ((a.yLabel == 1)) o= "Angry" ;
              else if ((a.yLabel == 0)) o= "No Entry" ;
